...
def worker_process(
    ...
    local_net = ActorCritic(config["network"]["state_size"], action_dim, shared_layers=config["network"]["shared_layers"], critic_hidden_layers=config["network"]["critic_hidden_layers"], actor_hidden_layers=config["network"]["actor_hidden_layers"]).to(device)
